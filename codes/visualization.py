...
def tsne(x, y=None, random_state=999, label_dict=None, size=20, marker='o', show_ticks=False, show_legend=False, save_path='',
         show_fig=True):
    """
    ...
    """
    embedding = manifold.TSNE(n_components=2, random_state=random_state).fit_transform(x)
    return embedding, y
